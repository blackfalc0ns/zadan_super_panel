...
export class VendorsListComponent implements OnInit {
 ...
 ? 'انتهت صلاحية الجلسة أو ما فيه صلاحية لعرض التجار. سجل الدخول مرة ثانية.'
 ...
 ? 'ما تقدر تعتمد التاجر الحين. أكمل مراجعة المستندات المطلوبة أولًا أو افتح تبويب الامتثال.'
 ...
 return new Intl.DateTimeFormat(this.activeLang === 'ar' ? 'ar-SA' : 'en-US', { timeZone: 'Asia/Riyadh',
 day: '2-digit',
 month: 'short',
 year: 'numeric'
