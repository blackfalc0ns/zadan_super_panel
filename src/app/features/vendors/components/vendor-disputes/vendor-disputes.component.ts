...
export class VendorDisputesComponent {
 ...
 createdDate: createdAt.toLocaleDateString(this.currentLang === 'ar' ? 'ar-SA-u-nu-latn' : 'en-US', {
 timeZone: 'Asia/Riyadh'
 }),
 createdTime: createdAt.toLocaleTimeString(this.currentLang === 'ar' ? 'ar-SA-u-nu-latn' : 'en-US', { timeZone: 'Asia/Riyadh',
 hour: '2-digit',
 minute: '2-digit'
 }),
