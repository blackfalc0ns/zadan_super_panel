...
export class VendorDetailHeaderComponent implements OnChanges {
 ...
 this.vendorDetailFacade.isVendorWorkspaceLoading$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe((loading) => {
 ...
 return new Intl.DateTimeFormat(this.currentLang === 'ar' ? 'ar-SA-u-nu-latn' : 'en-US', {
 day: '2-digit',
 month: 'short',
 year: 'numeric',
