...
import {
  ...
  createDefaultSupportCaseEscalationDecisionForm
} from '../../models/support-cases.models';

@Component({
  selector: 'app-support-case-escalation-modal',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, ModalShellComponent, SearchableSelectComponent],
  templateUrl: './support-case-escalation-modal.component.html',
  styleUrl: './support-case-escalation-modal.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SupportCaseEscalationModalComponent implements OnChanges {
  @Input() isOpen = false;
  @Input() isRtl = true;
  ...
  private createDefaultForm(dispute: SupportCaseRow): EscalationDecisionForm {
    return createDefaultSupportCaseEscalationDecisionForm(
      dispute,
