...
import { SupportCaseRow, RefundDecisionForm, createDefaultSupportCaseRefundDecisionForm } from '../../models/support-cases.models';

@Component({
  selector: 'app-support-case-approval-modal',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, ModalShellComponent, SearchableSelectComponent],
  templateUrl: './support-case-approval-modal.component.html',
  styleUrl: './support-case-approval-modal.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SupportCaseApprovalModalComponent implements OnChanges {
  @Input() isOpen = false;
  @Input() dispute: SupportCaseRow | null = null;
  ...
  private createDefaultForm(dispute: SupportCaseRow): RefundDecisionForm {
    return createDefaultSupportCaseRefundDecisionForm(
      dispute,
  ...
  private getSuggestedRefundAmount(dispute: SupportCaseRow): string {
