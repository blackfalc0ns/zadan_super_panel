...
import { SupportCaseRow, RejectionDecisionForm, RejectionReason } from '../../models/support-cases.models';

@Component({
  selector: 'app-support-case-rejection-modal',
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, ModalShellComponent],
  templateUrl: './support-case-rejection-modal.component.html',
  styleUrl: './support-case-rejection-modal.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SupportCaseRejectionModalComponent implements OnChanges {
  @Input() isOpen = false;
  @Input() isRtl = true;
  ...
  private createDefaultForm(dispute: SupportCaseRow): RejectionDecisionForm {
    return {
      reason: 'evidence',
