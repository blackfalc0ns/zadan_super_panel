...
const TIMELINE_TEXT_ALIASES: Record<string, string> = {
  ...
  'جاري البحث عن سائق': 'TITLES.DRIVER_ASSIGNMENT_IN_PROGRESS',
  'driver assignment in progress': 'TITLES.DRIVER_ASSIGNMENT_IN_PROGRESS',
  'تم تعيين السائق': 'TITLES.DRIVER_ASSIGNED',
  ...
  'وافق السائق على عرض التوصيل.': 'SUBTITLES.DRIVER_ACCEPTED_OFFER',
  'driver accepted delivery offer.': 'SUBTITLES.DRIVER_ACCEPTED_OFFER',
  ...
  'جاري البحث عن سائقين.': 'SUBTITLES.SEARCHING_DRIVERS',
  'searching for drivers.': 'SUBTITLES.SEARCHING_DRIVERS',
  'لا يوجد سائقين متاحين.': 'SUBTITLES.NO_DRIVERS',
...
const TIMELINE_ICON_PATTERNS: Array<{ includes: string; icon: string }> = [
  ...
  { includes: 'تعيين السائق', icon: 'delivery_truck_speed' },
  ...
  { includes: 'مسترد', icon: 'currency_exchange' },
