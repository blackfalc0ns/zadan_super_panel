            ...
            <div class="grid gap-3 md:grid-cols-1">
              <label class="flex cursor-pointer items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                ...
                <input
                  ...
                  [(ngModel)]="s.deliveryOptionEnabled"
              ...
              >
                ...
                <input
                  ...
                  [disabled]="!s.pickupOptionEnabled"
                />
              </label>
            </div>
          </section>
            ...
            <div class="grid gap-5 md:grid-cols-2">
              ...
              <label class="flex flex-col gap-2">
                ...
                <input
                  ...
                  max="168"
                  class="h-12 rounded-2xl border border-slate-200 px-4 text-[14px] font-bold text-slate-900 outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100"
                  [(ngModel)]="s.pickupNoShowTimeoutHours"
                  name="pickupNoShowTimeoutHours"
                />
              </label>
...
export class PickupSettingsComponent implements OnInit {
  ...
  load(): void {
    ...
    this.pickupSettingsService.getSettings().subscribe({
      next: (settings: PlatformPickupSettings) => {
  ...
  save(): void {
    ...
    const body: UpsertPlatformPickupSettingsRequest = {
      deliveryOptionEnabled: !!current.deliveryOptionEnabled,
      pickupOptionEnabled: !!current.pickupOptionEnabled,
      ...
      pickupNoShowTimeoutHours: Number(current.pickupNoShowTimeoutHours ?? 24),
    ...
    this.pickupSettingsService.updateSettings(body).subscribe({
      next: (settings: PlatformPickupSettings) => {
        this.settings.set({ ...settings });
